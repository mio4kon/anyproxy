  ...
  return function (req, userRes) {
    ...
    const prepareRequestDetail = () => {
      ...
      return Promise.resolve();
        ...
        /**
         * 检查是否需要mock数据
         * API MOCK :  127.0.0.1:8001/lich.mock_service/mock
         * HEAD: Mock-Data = {"url":"/login","type":"error"}
         * API CLEAR :  127.0.0.1:8001/lich.mock_service/clear
         */
        ...
        switch (routeUrl) {
          ...
          case '/mock': {
            ...
            if (requsetMockInfo.mockUrls === undefined) {
              ...
              requsetMockInfo.mockUrls.push(reqMockUrls);
            } else {
            ...
            logUtil.printLog(color.yellow(`prepare to mock urls : ${JSON.stringify(requsetMockInfo.mockUrls)}`));
    ...
    co(fetchReqData)
            ...
            .then(co.wrap(function*(userConfig) {
              ...
              if (isMockData && matched) {
                ...
                logUtil.printLog(color.yellow(`mock url: [${path}], return body from database : [${lichMockInfo.mockBody}]`));
                return userConfig;
              }
